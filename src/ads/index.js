...
const selection = [
  ...
  {
    title:
      'Ad | All-new Echo (3rd Gen) - Smart speaker with Alexa - Twilight Blue',
    link: 'https://amzn.to/2ntWMu4',
    content:
      '<img src="https://ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&ASIN=B07R1CXKN7&Format=_SL160_&ID=AsinImage&MarketPlace=US&ServiceVersion=20070822&WS=1&tag=mamaskind-20"> Meet Echo - Echo (3rd Gen) has new premium speakers powered by Dolby to play 360° audio with crisp vocals and dynamic bass response.',
    contentSnippet:
  ...
  },
  {
    ...
    content:
      '<img border="0" src="//ws-na.amazon-adsystem.com/widgets/q?_encoding=UTF8&ASIN=B01LOP8EZC&Format=_SL250_&ID=AsinImage&MarketPlace=US&ServiceVersion=20070822&WS=1&tag=mamaskind-20&language=en_US"> The most advanced PlayStation system ever. PS4 Pro is designed to take your favorite PS4 games and add to them with more power for graphics, performance, or features for your 4K HDR TV, or 1080p HD TV. Ready to level up?',
    contentSnippet:
